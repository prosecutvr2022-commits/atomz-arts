      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="p-8 rounded-3xl bg-white border border-pink-100 shadow-md space-y-6">
              <h2 className="font-sans text-2xl font-bold text-[#831154]">
                Academy Helplines
              </h2>
              ...
              <div className="space-y-3">
                {CONTACT_INFO.phoneNumbers.map((phone, idx) => (
                  <a
                    ...
                    className="flex items-center justify-between p-3.5 rounded-xl bg-[#FFF1F7] hover:bg-pink-100 border border-pink-200 transition-all group"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-lg bg-[#831154] text-white flex items-center justify-center">
                        <Phone className="w-4 h-4" />
                      </div>
                      <div>
                        <div className="font-mono font-bold text-slate-900 group-hover:text-[#e71e92] text-sm">
                          {phone}
                        </div>
                    ...
                    <span className="text-xs font-bold text-[#e71e92] group-hover:translate-x-1 transition-transform">
                      Call →
                    </span>
                  </a>
                ))}
            ...
            <div className="p-8 rounded-3xl bg-[#831154] text-white shadow-md space-y-6">
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-pink-200 flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="block text-white">Academy Campus:</strong>
                    <span className="text-pink-100 leading-relaxed font-normal">
                      {CONTACT_INFO.address}
                    </span>
                    <span className="block font-tamil text-pink-200 mt-1">
                ...
                <div className="flex items-start gap-3">
                  <Clock className="w-5 h-5 text-pink-200 flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="block text-white">Operating Hours:</strong>
                    <span className="text-pink-100 font-normal">
                      {CONTACT_INFO.workingHours}
                    </span>
                    <span className="block text-pink-200 text-xs font-normal">
                ...
                <div className="flex items-start gap-3">
                  <Mail className="w-5 h-5 text-pink-200 flex-shrink-0 mt-0.5" />
                  <div>
                    <strong className="block text-white">Email ID:</strong>
                    <a href={`mailto:${CONTACT_INFO.email}`} className="text-pink-100 hover:text-white transition-colors font-normal">
                      {CONTACT_INFO.email}
                    </a>
                  </div>
                </div>
          ...
          <div className="lg:col-span-7">
            <div className="p-8 sm:p-10 rounded-3xl bg-white border border-pink-100 shadow-xl space-y-6">
              <div className="space-y-2">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-pink-100 text-[#831154] text-xs font-bold uppercase tracking-wider">
                  <Sparkles className="w-3.5 h-3.5 text-[#e71e92]" />
              ...
              {submitted ? (
                <motion.div
                  ...
                  className="p-8 rounded-2xl bg-pink-50 border border-pink-200 text-center space-y-4"
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-xl bg-white border border-pink-200 text-xs sm:text-sm focus:outline-none focus:border-[#e71e92] focus:ring-2 focus:ring-[#e71e92]/10 text-slate-900"
                      />
                    </div>
