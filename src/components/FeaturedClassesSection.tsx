...
export const FeaturedClassesSection: React.FC<FeaturedClassesSectionProps> = ({
  ...
  return (
    <section className="py-20 bg-[#FFF1F7] text-slate-900 border-b border-pink-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          <div className="inline-flex items-center gap-1.5 px-4 py-1 rounded-full bg-pink-100 border border-pink-200 text-[#e71e92] text-xs font-extrabold uppercase tracking-wider">
            <Sparkles className="w-4 h-4 text-[#e71e92]" />
            <span>Curriculum & Disciplines</span>
          </div>

          <h2 className="font-sans text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#831154] tracking-tight">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-10">
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-bold whitespace-nowrap transition-all cursor-pointer ${
                    isActive
                      ? 'bg-[#831154] text-white shadow-md border border-[#831154]'
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white border border-pink-200 text-sm focus:outline-none focus:border-[#e71e92] focus:ring-2 focus:ring-[#e71e92]/10 shadow-xs text-slate-900"
            />
          </div>
        </div>
        ...
        {filteredCourses.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl border border-pink-200 p-8 space-y-3">
            ...
            <button
              ...
              className="px-5 py-2 rounded-xl bg-[#e71e92] text-white text-xs font-bold"
            >
              Reset Filters
            </button>
          </div>
        ...
        <div className="mt-14 text-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#e71e92] hover:bg-[#d11481] text-white font-extrabold text-sm sm:text-base shadow-lg hover:shadow-pink-500/20 hover:scale-105 active:scale-95 transition-all cursor-pointer"
          >
