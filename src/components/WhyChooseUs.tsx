...
export const WhyChooseUs: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-white text-slate-900 border-b border-pink-100">
          ...
          {points.map((point, index) => {
            ...
            return (
              <motion.div
                ...
                className="group p-6 rounded-2xl bg-white border border-pink-100 hover:border-[#e71e92] shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col justify-between"
              >
                <div className="space-y-4">
                  <div className="w-12 h-12 rounded-xl bg-[#e71e92] flex items-center justify-center text-white shadow-md group-hover:scale-110 transition-transform">
                    <Icon className="w-6 h-6" />
                  </div>

                  <div>
                    <h3 className="font-sans text-lg font-bold text-[#831154] group-hover:text-[#e71e92] transition-colors">
                      {point.title}
                    </h3>
                    <p className="font-tamil text-xs text-[#e71e92] font-semibold mt-0.5">
                      {point.tamil}
                    </p>
                  </div>
                ...
                <div className="pt-4 mt-4 border-t border-pink-50 flex items-center justify-between text-xs text-[#e71e92] font-bold">
