      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-end justify-between gap-4 mb-12">
          <div className="space-y-2">
            ...
            <h2 className="font-sans text-3xl sm:text-4xl font-extrabold text-[#831154]">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#e71e92] hover:bg-[#d11481] text-white text-xs sm:text-sm font-bold shadow-md transition-all cursor-pointer whitespace-nowrap"
          >
          ...
          {featured.map(item => (
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white space-y-1">
                <h3 className="font-sans text-base sm:text-lg font-bold text-white line-clamp-1">
                  {item.title}
                </h3>
